...
-- Run this after 00-complete-database-schema.sql
...
CREATE INDEX IF NOT EXISTS idx_outreach_locations_active ON outreach_locations(is_active);
CREATE INDEX IF NOT EXISTS idx_outreach_locations_name ON outreach_locations(name);
...
CREATE TABLE IF NOT EXISTS outreach_runs (
  ...
  team_members TEXT[],
  planned_locations INTEGER[],
  actual_locations INTEGER[],
...
CREATE INDEX IF NOT EXISTS idx_outreach_inventory_category ON outreach_inventory(category);
...
CREATE INDEX IF NOT EXISTS idx_outreach_clients_name ON outreach_clients(first_name, last_name);
...
CREATE INDEX IF NOT EXISTS idx_outreach_run_supplies_run ON outreach_run_supplies(run_id);
...
CREATE INDEX IF NOT EXISTS idx_outreach_inventory_alerts_resolved ON outreach_inventory_alerts(is_resolved);
...
-- Insert common outreach locations
