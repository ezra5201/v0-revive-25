...
export function IntakeFormModal({ isOpen, onClose, clientId, clientName }: IntakeFormModalProps) {
  ...
  const calculateBasicInfoCompletion = () => {
    const fields = [formData.name, formData.pronouns, formData.dateOfBirth, formData.program, formData.howHeardAboutUs]
  ...
  const SectionHeader = ({
    ...
    <CollapsibleTrigger asChild>
      <Button variant="ghost" className="w-full justify-between p-4 h-auto" onClick={() => toggleSection(section)}>
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <div className="flex items-center gap-4 mt-2">
            ...
            <Badge variant={overallCompletion === 100 ? "default" : "secondary"}>{overallCompletion}% Complete</Badge>
          </div>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <Collapsible open={sectionStates.basicInfo} onOpenChange={() => toggleSection("basicInfo")}>
            <SectionHeader title="Basic Information" section="basicInfo" completion={sectionCompletion.basicInfo} />
          ...
          <Collapsible open={sectionStates.supportNeeds} onOpenChange={() => toggleSection("supportNeeds")}>
            <SectionHeader title="Support Needs" section="supportNeeds" completion={sectionCompletion.supportNeeds} />
            <CollapsibleContent className="px-4 pb-4 space-y-4">
              <div>
                <Label className="text-base font-medium">
                  What support do you hope to have at ReVive's Engagement Center?
                </Label>
                <div className="mt-2 space-y-4">
                  ...
                  <div>
                    <Label className="text-sm font-medium text-muted-foreground">See a:</Label>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-2">
                      {SEE_STAFF_OPTIONS.map((staff) => (
                        <div key={staff} className="flex items-center space-x-2">
                          ...
                          />
                          <Label htmlFor={`staff-${staff}`} className="text-sm">
                            {staff}
                          </Label>
                        </div>
                      ))}
                  ...
                  <div>
                    <Label htmlFor="otherSupport">Other:</Label>
                    <Textarea
                      id="otherSupport"
          ...
          <Collapsible open={sectionStates.housing} onOpenChange={() => toggleSection("housing")}>
            ...
            <CollapsibleContent className="px-4 pb-4 space-y-4">
              <div>
                <Label className="text-sm font-medium">Current Housing Status:</Label>
                <div className="grid grid-cols-1 gap-2 mt-2">
                  {HOUSING_STATUS_OPTIONS.map((status) => (
                    <div key={status} className="flex items-center space-x-2">
                      ...
                      />
                      <Label htmlFor={`current-housing-${status}`} className="text-sm">
                        {status}
                      </Label>
                    </div>
                  ))}
              ...
              <div>
                <Label className="text-sm font-medium">Past Housing Status:</Label>
                <div className="flex items-center space-x-2 mt-2">
                  ...
                  />
                  <Label htmlFor="past-housing-homeless" className="text-sm">
                    I have been homeless or had unstable housing
                  </Label>
                </div>
                <div className="flex items-center space-x-2 mt-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => handleCheckboxChange("pastHousingStatus", "N/A", checked as boolean)}
                  />
                  <Label htmlFor="past-housing-na" className="text-sm">
                    N/A
                  </Label>
                </div>
              </div>
          ...
          <Collapsible open={sectionStates.employment} onOpenChange={() => toggleSection("employment")}>
            ...
            <CollapsibleContent className="px-4 pb-4 space-y-4">
              ...
              <div>
                <Label className="text-sm font-medium">I have:</Label>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-2">
                  {INCOME_SOURCES.map((source) => (
                    <div key={source} className="flex items-center space-x-2">
                      ...
                      />
                      <Label htmlFor={`income-${source}`} className="text-sm">
                        {source}
                      </Label>
                    </div>
                  ))}
